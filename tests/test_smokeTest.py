...
class TestSmokeTest():
  ...
  def test_homeLinks(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1233, 692)
  ...
  def test_directorypage(self):
    ...
    self.driver.set_window_size(1175, 692)
  ...
  def test_joinPage(self):
    ...
    self.driver.set_window_size(1260, 692)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").click()
    self.driver.find_element(By.NAME, "fname").send_keys("first")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("last")
  ...
  def test_adminpage(self):
    ...
    self.driver.set_window_size(1164, 692)
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("sggrdrg")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("23423453")
